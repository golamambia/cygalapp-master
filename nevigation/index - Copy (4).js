...
import { COLORS, SIZES,Hosturl,Imgurl } from "../constants/theme";
            ...
            <Drawer.Navigator  screenOptions={{
              ...
              swipeEnabled: false,
                ...
                drawerItemStyle:{
                    ...
                    borderRadius:0,marginVertical: 0,borderBottomWidth:0.10,
                },
    drawerStyle: {
   ...
   <Drawer.Screen  options={{ headerShown: false,swipeEnabled: false,  
    ...
    (
      <AntDesign name="home" style={{marginRight:-22,marginLeft:5}} color='#fff' width={20}  size={20}/>
                       ...
                       <View style={styles.download}><View style={styles.cartdiv}>
<Text style={styles.carttext}>{totalcart}</Text>
</View><CartVariant size={SIZES.h2} color={'#000'} /></View>
...
const styles = StyleSheet.create({
    ...
    drawerContent: {
      ...
      image: {
        ...
        cartdiv:{zIndex:1,bottom:11,left:10,width:16,height:16,
